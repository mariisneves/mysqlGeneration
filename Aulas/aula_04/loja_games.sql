...
CREATE TABLE tb_usuarios (
  ...
  PRIMARY KEY (`id`) -- tanto faz se tiver essas aspas ou não
  );
...
-- o ideal é não ultrapassar de 3 inner joins senão o sistema vai ficar muuuuito lento
-- quanto menos tabela relacionada, mais rápida fica a estrutura do banco de dados